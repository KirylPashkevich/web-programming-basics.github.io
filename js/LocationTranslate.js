...
document.addEventListener("DOMContentLoaded", () => {
    const translations = {
        en: {
            ...
            "#ham-news": "News",
            ".header-content-nav-rectangle": "Contact Us",
            ...
            ".header-content-nav-rectangle-text": "Contact US",

            //main
            "#maps-fb": "Our X: @RubyHome",
            "#maps-x": "Our FB: @RubyHome",
            "#maps-inst": "Our inst: @RubyHome",
        ...
        ru: {
            ...
            "#ham-news": "Новости",
            ".header-content-nav-rectangle": "Связаться с нами",
            ...
            ".header-content-nav-rectangle-text": "Связаться с нами",

            //main
            "#maps-fb": "Наш Х: @RubyHome",
            "#maps-x": "Наш фейсбук: @RubyHome",
            "#maps-inst": "Наш инстаграм: @RubyHome",
            "#maps-socials-header-upper":
