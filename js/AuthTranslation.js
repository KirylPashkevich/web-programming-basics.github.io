...
document.addEventListener("DOMContentLoaded", () => {
    const translations = {
        en: {
            //auth-left
            ".auth-left-company": "RUBYHOME.COM",
            ".auth-left-desc":
                "Here at RUBYHOME, we value all new future customers, as well as their privacy. Please, don't use weak passwords.",
            ".footer-content-text-button-language": "Change language",
            ".footer-content-text-button-theme": "Change theme",
            ".login-introduction":
                "Welcome to RUBYHOME. Feel free to check out our full webpage after registering. Please, proceed with entering your nickname and password and enjoy everything we have to offer.",
            ...
            ".register-introduction":
                "Welcome to RUBYHOME. Fill out this form and be a new awesome user of our platform with more content awaiting you.",
        ...
        ru: {
            //auth-left
            ".auth-left-company": "RUBYHOME.RU",
            ".auth-left-desc":
                "Здесь, в RUBYHOME, мы ценим всех новых будущих клиентов, а также их конфиденциальность. Пожалуйста, не используйте слабые пароли.",
            ".footer-content-text-button-language": "Сменить язык",
            ".footer-content-text-button-theme": "Сменить тему",
            ".login-introduction":
                "Добро пожаловать в RUBYHOME. Чувствуйте себя свободно, чтобы изучить нашу полную веб-страницу после регистрации. Пожалуйста, введите свой никнейм и пароль и наслаждайтесь всем, что мы можем предложить.",
            ...
            ".register-introduction":
                "Добро пожаловать в RUBYHOME. Заполните эту форму и станьте пользователем нашей платформы, на которой вас ждет больше контента.",
